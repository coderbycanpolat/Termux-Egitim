...
Eğitime Hoşgeldiniz Öğrenmek İçin Lütfen Sırayla İle İlerleyiniz....
...
21)Kapanış  Ve İletişim
q)Çıkış
""")

ilk = input("Neyi Öğrenmek İstersiniz : ")
...
""")
	...
	if dev=="e" or dev=="E":
		print("Kullanıcağımız aracı indiriyorum...")
		os.system("sleep 3")
...
örnek olarak "git clone https://github.com/coderbycanpolat/kurulum" Şeklinde yazmanız gerekir
Sonra indirilen dosyanın içine girmek için "cd" komutunu kullanıyoruz
örneğin "cd kurulum" bu komutla eğer dosya orada ise dosyanın içine girecektir.
...
""")
				...
				if dev=="e" or dev=="E":
					print("""\033[1m\033[92m
2. Brute Force (Kaba Kuvvet Yolu)
...
Methodları Telegram : @androedit Kanalında bulabilirsiniz.
""")
			elif dev=="h" or dev=="H":
				quit()
	elif dev=="h" or dev=="H":
...
""")
	...
	os.system("clear")
	print("""\033[1m\033[92m
Kendi Hazırlamış Olduğum Set İçinde A dan Z ya Her Şey Mevcuttur.

LİNK: https://lnkload.com/2vS3V

ALTERNATİF LİNK: https://lnkload.com/2vS3Y
...
Kendi Kodladığım Bir Araç Var Kurmanı Tavsiye Ederim 
""")
	dev = input("Devam Edilsin mi [E/h] ")
	if dev=="E" or dev=="e":
		os.system("clear")
		...
		os.chdir("/data/data/com.termux/files/home")
		os.system("clear")
		os.system("git clone https://github.com/coderbycanpolat/kisiye-ozel-wordlist")
		os.chdir("/data/data/com.termux/files/home/kisiye-ozel-wordlist")
		os.system("chmod 777 *")
		os.system("clear")
		print("""\033[1m\033[92m
Şuan Aracımız Kuruldu Bu yazıdan Sonra "cd" yazıp ana dizine gidin sonra "cd kisiye-ozel-wordlist" yazıp dosyaya gidin "ls" yazıp dizini görüntüleyin ve 
"bash termux-wordlist.sh" yazın gelen yerlerde bilgileri doldurun wordlistiniz hazır :)""")
	elif dev=="h" or dev=="H":
        	exit()
...
Göz Önünde Bulundurmak Ve 1 Yaparken 2 Kere Düşünmektir Unutmayın Hayattaki Herşey Zevk ten ibaret Değildir !

BANA ULAŞIM

İNSTAGRAM:canpolatgkky
TELEGRAM:androedit
YOUTUBE:CANPOLAT GÖKKAYA



GÖRÜŞÜRÜZ KENDİNİZE İYİ BAKIN .......
